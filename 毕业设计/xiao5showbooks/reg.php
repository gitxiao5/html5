...
<html>
  ...
  <body>
    ...
    <form method= "post" action = "http://localhost/xiao5showbooks/manage/adduser.php">
	   <div class = "int">
	...
	<p id = "tips"><?php if($_GET['action']==2) echo "您刚刚输入的的验证码是错误的！"?></p>
	 </div>
	<div id = "footer">
	 ...
	 <!--验证：<input type="text" size="6" id="code_num" name="code_num"/>
				<img src="code.php" onclick="this.src='code.php?id='+Math.random()"/> <br/><br/>
	  <input type="button" id="chk_num" value="用户登录"/>-->
  </body>
</html>